                        ...
                        <td style="padding: 0 40px 30px 40px;">
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #ffffff; border: 1px solid #e9ecef; border-radius: 8px; overflow: hidden;">
                                    ...
                                    <tbody>
                                        @foreach ($data['ds_ve'] as $index => $value)
                                            ...
                                            <td style="padding: 12px; text-align: right; color: #1a1a2e; font-weight: 600; font-size: 14px; border-bottom: 1px solid #f8f9fa;"> {{number_format($value->gia_ve)}}</td>
                                            </tr>
                                        @endforeach
                            ...
                            <div style="background-color: #1a1a2e; border-radius: 8px; padding: 20px; margin-bottom: 25px;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                    ...
                                    <span style="color: #ffffff; font-size: 16px;"> {{ number_format($data['tam_tinh'])}}</span>
                                </div>
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                                    <span style="color: #ffffff; font-size: 16px;">Giảm Giá:</span>
                                    <span style="color: #e17055; font-size: 16px;"> -{{ number_format($data['tien_giam_gia'])}}</span>
                                </div>
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    ...
                                    <span style="color: #ffd700; font-size: 24px; font-weight: bold;"> {{ number_format($data['so_tien'])}}</span>
                                </div>
                            </div>
                            ...
                            <div style="text-align: center; background-color: #f8f9fa; border-radius: 8px; padding: 25px;">
                                ...
                                <div style="display: inline-block; background-color: #ffffff; border: 2px solid #e9ecef; border-radius: 8px; padding: 20px; margin-bottom: 15px;">
                                    <div style="width: 150px; height: 150px; background-color: #f8f9fa; border: 1px solid #dee2e6; display: flex; align-items: center; justify-content: center; font-size: 12px; color: #666666; text-align: center; line-height: 1.3;">
